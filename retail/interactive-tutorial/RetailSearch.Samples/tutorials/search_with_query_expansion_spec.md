...
1. Open <walkthrough-editor-select-regex filePath="cloudshell_open/interactive-tutorial/RetailSearch.Samples/SearchWithQueryExpansionTutorial.cs" regex="TRY DIFFERENT QUERY EXPANSION CONDITION HERE">SearchWithQueryExpansionTutorial.cs</walkthrough-editor-select-regex>.
...
3. Run the sample in the Terminal using the command:
    ```bash
    dotnet run -- SearchWithQueryExpansionTutorial
    ```
...
1. Change the condition under the <walkthrough-editor-select-regex filePath="cloudshell_open/interactive-tutorial/RetailSearch.Samples/SearchWithQueryExpansionTutorial.cs" regex="TRY DIFFERENT QUERY EXPANSION CONDITION HERE">comment</walkthrough-editor-select-regex> to the following:
